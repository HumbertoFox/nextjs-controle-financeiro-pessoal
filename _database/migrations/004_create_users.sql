...
-- TABLE COMMENT
-- ============================================================================
COMMENT ON TABLE users IS 'Tabela principal de usuários do sistema com suporte a soft delete, autenticação múltipla e controle de sessão única via session_version';

-- ============================================================================
-- COLUMN COMMENTS
-- ============================================================================
COMMENT ON COLUMN users.id              IS 'Identificador único do usuário (UUID v4)';
COMMENT ON COLUMN users.family_id       IS 'Identificador da família associada';
